...
class WebhookController extends Controller
{
    public function midtransHandler(Request $request)
    {
        ...
        // check wheter order status on database is success or not
        // if it's success, it may not be changed (indicate valid webhook hit twice or more)
